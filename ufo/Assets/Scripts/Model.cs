...
public class Model : MonoBehaviour, ForModel
{
    ...
    public void changemode(){
        myfactory.mode=1-myfactory.mode;
    }
    ...
    public void Restart(){
        ...
        controller.running=true;
        myfactory.manager1.running=true;
    }
    ...
    void Update()
    {
		...
		// 			// Debug.Log ("hit " + hit.collider.gameObject.name +"!" ); 
		// 		}
        //         myfactory.recycleUFO(hit.transform.parent.transform.gameObject);
